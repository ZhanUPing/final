...
#include	"/home/m110/m110061606/ee6470/final3/SobelFilter.cpp"
...
void SobelFilter_wrapper::InitInstances(  )
{
	...
	switch ( rep )
	{
		case BDWRep_Gates:
		    ...
		    SobelFilter_cosim0->o_avg_busy(o_avg.busy);
		    SobelFilter_cosim0->o_avg_vld(o_avg.vld);
		    SobelFilter_cosim0->o_avg_data(o_avg.data);
		...
		case BDWRep_RTL_C:
		    ...
		    SobelFilter_rtl0->o_avg_busy(o_avg.busy);
		    SobelFilter_rtl0->o_avg_vld(o_avg.vld);
		    SobelFilter_rtl0->o_avg_data(o_avg.data);
		...
		case BDWRep_Behavioral:
		    ...
		    SobelFilter0->o_avg.busy(o_avg.busy);
		    SobelFilter0->o_avg.vld(o_avg.vld);
		    SobelFilter0->o_avg.data(o_avg.data);
...
void SobelFilter_wrapper_r::InitInstances()
{
	...
	switch ( rep )
	{
		case BDWRep_Gates:
		    ...
		    SobelFilter_cosim0->o_avg_busy(o_avg_busy);
		    SobelFilter_cosim0->o_avg_vld(o_avg_vld);
		    SobelFilter_cosim0->o_avg_data(o_avg_data);
		...
		case BDWRep_RTL_C:
		    ...
		    SobelFilter_rtl0->o_avg_busy(o_avg_busy);
		    SobelFilter_rtl0->o_avg_vld(o_avg_vld);
		    SobelFilter_rtl0->o_avg_data(o_avg_data);
		...
		case BDWRep_Behavioral:
		    ...
		    SobelFilter0->o_avg.busy(o_avg_busy);
		    SobelFilter0->o_avg.vld(o_avg_vld);
		    SobelFilter0->o_avg.data(o_avg_data);
