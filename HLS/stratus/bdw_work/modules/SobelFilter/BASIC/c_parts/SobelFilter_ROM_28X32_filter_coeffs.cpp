...
SobelFilter_ROM_28X32_filter_coeffs::SobelFilter_ROM_28X32_filter_coeffs(sc_module_name name) : sc_module(name) 
    ...
    ,filter_coeffs()
{
  HLS_INITIALIZE_ROM( sc_uint<32> , filter_coeffs, HLS::HLS_HEX, "bdw_work/modules/SobelFilter/BASIC/SobelFilter_ROM_28X32_filter_coeffs_3.memh", "initialize SobelFilter_ROM_28X32_filter_coeffs" ); 
