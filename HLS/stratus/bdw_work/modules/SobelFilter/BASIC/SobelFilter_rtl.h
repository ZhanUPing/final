...
struct SobelFilter : public sc_module {
  ...
  sc_signal<sc_uint<1> > SobelFilter_gen_busy_r_4_22_gdiv;
  sc_signal<sc_uint<1> > SobelFilter_gen_busy_r_4_22_gnew_req;
  sc_signal<sc_uint<4> > global_state_next;
  sc_signal<sc_uint<1> > gs_ctrl_do_filter_h200;
  sc_signal<sc_uint<32> > SobelFilter_Add_32Ux32U_32U_4_12_in1;
  sc_signal<sc_uint<1> > gs_ctrl_do_filter_h800;
  sc_signal<sc_uint<32> > SobelFilter_Add_32Ux32U_32U_4_12_in2;
  sc_signal<sc_uint<2> > gs_ctrl_do_filter_h2800;
  sc_signal<sc_uint<32> > SobelFilter_Mul_32Ux32U_32U_4_11_out1;
  sc_signal<sc_uint<32> > SobelFilter_Mul_32Ux32U_32U_4_11_in1;
  sc_signal<sc_uint<32> > SobelFilter_Mul_32Ux32U_32U_4_11_in2;
  ...
  sc_signal<sc_uint<2> > gs_ctrl_do_filter_h6b0;
  sc_signal<sc_uint<2> > gs_ctrl_do_filter_h906;
  sc_signal<sc_uint<3> > gs_ctrl_do_filter_h1f86;
  sc_signal<sc_uint<2> > gs_ctrl_do_filter_h900;
  sc_signal<sc_uint<3> > gs_ctrl_do_filter_h1f84;
  sc_signal<sc_uint<2> > gs_ctrl_do_filter_h4b;
  sc_signal<sc_uint<3> > gs_ctrl_do_filter_h447f;
  sc_signal<sc_uint<2> > gs_ctrl_do_filter_h48;
  sc_signal<sc_uint<2> > gs_ctrl_do_filter_h4466;
  sc_signal<sc_uint<5> > s_reg_5_slice;
  sc_signal<sc_uint<32> > s_reg_13;
  sc_signal<sc_int<6> > SobelFilter_Sub_5Ux1U_6S_4_8_out1;
  sc_signal<sc_uint<6> > SobelFilter_Add_5Ux1U_6U_4_6_out1;
  sc_signal<sc_uint<6> > s_reg_11;
  sc_signal<sc_uint<3> > SobelFilter_gen_busy_r_4_22_out1;
  sc_signal<sc_uint<1> > SobelFilter_And_1Ux1U_1U_4_20_out1;
  ...
  sc_signal<sc_uint<1> > SobelFilter_GreaterThan_6Sx2S_1U_4_10_out1;
  sc_signal<sc_uint<6> > SobelFilter_Add_5Ux1U_6U_4_7_out1;
  ...
  void SobelFilter_GreaterThan_6Sx2S_1U_4_10();
  void drive_SobelFilter_Mul_32Ux32U_32U_4_11_in2();
  void drive_SobelFilter_Mul_32Ux32U_32U_4_11_in1();
  void SobelFilter_Mul_32Ux32U_32U_4_11();
  void drive_SobelFilter_Add_32Ux32U_32U_4_12_in2();
  void drive_SobelFilter_Add_32Ux32U_32U_4_12_in1();
  ...
  void drive_gs_ctrl_do_filter_h4466();
  void drive_gs_ctrl_do_filter_h48();
  void drive_gs_ctrl_do_filter_h447f();
  void drive_gs_ctrl_do_filter_h4b();
  void drive_gs_ctrl_do_filter_h1f84();
  void drive_gs_ctrl_do_filter_h900();
  void drive_gs_ctrl_do_filter_h1f86();
  void drive_gs_ctrl_do_filter_h906();
  void drive_gs_ctrl_do_filter_h6b0();
  void drive_gs_ctrl_do_filter_h10();
  void drive_gs_ctrl_do_filter_h400();
  void drive_gs_ctrl_do_filter_h2800();
  void drive_gs_ctrl_do_filter_h800();
  void drive_gs_ctrl_do_filter_h200();
  void drive_i_rgb_busy();
  void SobelFilter_gen_busy_r_4_22_p7();
  void SobelFilter_gen_busy_r_4_22_p6();
  void SobelFilter_gen_busy_r_4_22_p5();
  void SobelFilter_gen_busy_r_4_22_p4();
  ...
  void SobelFilter_And_1Ux1U_1U_4_20();
