...
SobelFilter::SobelFilter(sc_module_name name) : sc_module(name) 
    ...
    ,gs_ctrl_do_filter_h2e0000e924924("gs_ctrl_do_filter_h2e0000e924924")
    ...
    ,gs_ctrl_do_filter_h5ff402db6d0("gs_ctrl_do_filter_h5ff402db6d0")
    ,SobelFilter_Mul_32Sx8S_32S_4_6_in2("SobelFilter_Mul_32Sx8S_32S_4_6_in2")
    ,gs_ctrl_do_filter_h5ff416db6d8("gs_ctrl_do_filter_h5ff416db6d8")
    ...
    ,stall0("stall0")
{
  ...
  sensitive << ( gs_ctrl_do_filter_h5ff416db6d8 );
  sensitive << ( s_reg_4 );
  sensitive << ( s_reg_56 );
  sensitive << ( s_reg_10 );
  sensitive << ( s_reg_14 );
  ...
  sensitive << ( gs_ctrl_do_filter_h5ff402db6d0 );
  ...
  sensitive << ( gs_ctrl_do_filter_h2e0000e924924 );
  sensitive << ( s_reg_9 );
  sensitive << ( s_reg_4 );
  sensitive << ( s_reg_12 );
  sensitive << ( s_reg_17 );
  ...
  SC_METHOD(drive_gs_ctrl_do_filter_h5ff416db6d8);
  sensitive << i_clk.pos();
  dont_initialize();

  SC_METHOD(drive_gs_ctrl_do_filter_h5ff402db6d0);
  sensitive << i_clk.pos();
  dont_initialize();
  ...
  SC_METHOD(drive_gs_ctrl_do_filter_h2e0000e924924);
  sensitive << i_clk.pos();
  dont_initialize();
...
void SobelFilter::drive_o_avg_data(){
  ...
  default:
    ...
    case 1ULL: case 25ULL: case 26ULL: case 27ULL: case 28ULL: case 29ULL: case 
    30ULL: case 31ULL: case 32ULL: case 33ULL: case 34ULL: case 35ULL: case 
    36ULL: case 37ULL: case 38ULL: case 39ULL: case 40ULL: case 41ULL: case 
    42ULL: case 43ULL: case 44ULL: case 45ULL: case 46ULL: case 47ULL: case 
    50ULL: 
...
void SobelFilter::drive_s_reg_122(){
  ...
  default:
    switch( (sc_uint<6>)(global_state.read()) ) {
    case 0ULL: case 51ULL: 
      s_reg_122 = (sc_uint<32> ) ((sc_int<31> )s_reg_9.read());
      break;
    case 2ULL: case 3ULL: case 5ULL: case 6ULL: case 8ULL: case 9ULL: case 11ULL
    : case 12ULL: case 14ULL: case 15ULL: case 17ULL: case 18ULL: case 20ULL: 
    case 21ULL: case 23ULL: case 24ULL: case 49ULL: 
...
// resource: regr_en_32
void SobelFilter::drive_s_reg_146(){
  switch( (sc_uint<1>)(stall0.read()) ) {
  case 1ULL: 
    break;
  default:
...
void SobelFilter::drive_s_reg_66(){
  if ( (i_rst.read() == 0ULL) ) {
    ...
    default:
      switch( (sc_uint<6>)(global_state.read()) ) {
      case 0ULL: case 4ULL: case 7ULL: case 10ULL: case 13ULL: case 16ULL: case 
      19ULL: case 22ULL: case 48ULL: case 51ULL: 
        s_reg_66 = (sc_uint<32> ) (SobelFilter_Add_32Ux32U_32U_4_7_out1.read());
        break;
      }
      break;
    }
...
void SobelFilter::drive_SobelFilter_Mul_32Sx8S_32S_4_6_in2(){
  switch( (sc_uint<5>)(gs_ctrl_do_filter_h5ff416db6d8.read()) ) {
  default:
...
void SobelFilter::drive_SobelFilter_Mul_32Sx8S_32S_4_6_in1(){
  switch( (sc_uint<4>)(gs_ctrl_do_filter_h5ff402db6d0.read()) ) {
  default:
...
void SobelFilter::drive_SobelFilter_Add_32Ux32U_32U_4_7_in2(){
  ...
  case 1ULL: 
    SobelFilter_Add_32Ux32U_32U_4_7_in2 = ( (sc_uint<32> )(sc_bv<32>)(
                                          (sc_bv<31>)((sc_int<31> )s_reg_122
                                          .read()), 
                                          (sc_bv<1>)(0ULL)) );
    break;
  case 2ULL: 
    SobelFilter_Add_32Ux32U_32U_4_7_in2 = (sc_uint<32> ) (s_reg_66.read());
    break;
  case 3ULL: 
  ...
  case 11ULL: 
    SobelFilter_Add_32Ux32U_32U_4_7_in2 = ( (sc_uint<32> )(sc_bv<32>)(
                                          (sc_bv<31>)((sc_int<31> )s_reg_146
                                          .read()), 
                                          (sc_bv<1>)(0ULL)) );
    break;
  case 12ULL: 
    SobelFilter_Add_32Ux32U_32U_4_7_in2 = ( (sc_uint<32> )(sc_bv<32>)(
                                          (sc_bv<31>)((sc_int<31> )s_reg_66
                                          .read()), 
                                          (sc_bv<1>)(0ULL)) );
    break;
  }
...
void SobelFilter::drive_SobelFilter_Add_32Ux32U_32U_4_7_in1(){
  ...
  case 2ULL: 
    ...
    break;
  case 3ULL: 
    SobelFilter_Add_32Ux32U_32U_4_7_in1 = (sc_uint<32> ) (o_avg_data.read());
    break;
  }
}
...
void SobelFilter::drive_SobelFilter_Minus_32S_32S_4_8_in1(){
  switch( (sc_uint<4>)(gs_ctrl_do_filter_h2e0000e924924.read()) ) {
  default:
...
void SobelFilter::drive_gs_ctrl_do_filter_h5ff416db6d8(){
  if ( (i_rst.read() == 0ULL) ) {
    gs_ctrl_do_filter_h5ff416db6d8 = 0ULL;
  } else {
    switch( (sc_uint<1>)(stall0.read()) ) {
    case 1ULL: 
      break;
    default:
      ...
      default:
        ...
        break;
      case 3ULL: 
        gs_ctrl_do_filter_h5ff416db6d8 = 1ULL;
        break;
      case 4ULL: 
        gs_ctrl_do_filter_h5ff416db6d8 = 2ULL;
        break;
      case 6ULL: 
        gs_ctrl_do_filter_h5ff416db6d8 = 3ULL;
        break;
      case 7ULL: 
        gs_ctrl_do_filter_h5ff416db6d8 = 4ULL;
        break;
      case 9ULL: 
        gs_ctrl_do_filter_h5ff416db6d8 = 5ULL;
        break;
      case 10ULL: 
        gs_ctrl_do_filter_h5ff416db6d8 = 6ULL;
        break;
      case 12ULL: 
        gs_ctrl_do_filter_h5ff416db6d8 = 7ULL;
        break;
      case 13ULL: 
        gs_ctrl_do_filter_h5ff416db6d8 = 8ULL;
        break;
      case 15ULL: 
        gs_ctrl_do_filter_h5ff416db6d8 = 9ULL;
        break;
      case 16ULL: 
        gs_ctrl_do_filter_h5ff416db6d8 = 10ULL;
        break;
      case 18ULL: 
        gs_ctrl_do_filter_h5ff416db6d8 = 11ULL;
        break;
      case 19ULL: 
        gs_ctrl_do_filter_h5ff416db6d8 = 12ULL;
        break;
      case 21ULL: 
        gs_ctrl_do_filter_h5ff416db6d8 = 13ULL;
        break;
      case 22ULL: 
        gs_ctrl_do_filter_h5ff416db6d8 = 14ULL;
        break;
      case 24ULL: 
        gs_ctrl_do_filter_h5ff416db6d8 = 15ULL;
        break;
      case 30ULL: 
        gs_ctrl_do_filter_h5ff416db6d8 = 16ULL;
        break;
      case 32ULL: 
        gs_ctrl_do_filter_h5ff416db6d8 = 17ULL;
        break;
      case 33ULL: 
        gs_ctrl_do_filter_h5ff416db6d8 = 18ULL;
        break;
      case 34ULL: 
        gs_ctrl_do_filter_h5ff416db6d8 = 19ULL;
        break;
      case 35ULL: 
        gs_ctrl_do_filter_h5ff416db6d8 = 20ULL;
        break;
      case 36ULL: 
        gs_ctrl_do_filter_h5ff416db6d8 = 21ULL;
        break;
      case 37ULL: 
        gs_ctrl_do_filter_h5ff416db6d8 = 22ULL;
        break;
      case 38ULL: 
        gs_ctrl_do_filter_h5ff416db6d8 = 23ULL;
        break;
      case 39ULL: 
        gs_ctrl_do_filter_h5ff416db6d8 = 24ULL;
        break;
      case 40ULL: 
        gs_ctrl_do_filter_h5ff416db6d8 = 25ULL;
        break;
      case 42ULL: 
        gs_ctrl_do_filter_h5ff416db6d8 = 26ULL;
        break;
      }
      break;
    }
...
void SobelFilter::drive_gs_ctrl_do_filter_h5ff402db6d0(){
  if ( (i_rst.read() == 0ULL) ) {
    gs_ctrl_do_filter_h5ff402db6d0 = 0ULL;
  } else {
    switch( (sc_uint<1>)(stall0.read()) ) {
    case 1ULL: 
      break;
    default:
      ...
      default:
        gs_ctrl_do_filter_h5ff402db6d0 = 0ULL;
        break;
      case 4ULL: case 21ULL: 
        gs_ctrl_do_filter_h5ff402db6d0 = 1ULL;
        break;
      case 6ULL: case 19ULL: case 30ULL: case 42ULL: 
        gs_ctrl_do_filter_h5ff402db6d0 = 2ULL;
        break;
      case 7ULL: case 18ULL: case 32ULL: case 40ULL: 
        gs_ctrl_do_filter_h5ff402db6d0 = 3ULL;
        break;
      case 9ULL: case 16ULL: 
        gs_ctrl_do_filter_h5ff402db6d0 = 4ULL;
        break;
      case 10ULL: case 15ULL: 
        gs_ctrl_do_filter_h5ff402db6d0 = 5ULL;
        break;
      case 12ULL: case 13ULL: 
        gs_ctrl_do_filter_h5ff402db6d0 = 6ULL;
        break;
      case 33ULL: case 39ULL: 
        gs_ctrl_do_filter_h5ff402db6d0 = 7ULL;
        break;
      case 34ULL: case 38ULL: 
        gs_ctrl_do_filter_h5ff402db6d0 = 8ULL;
        break;
      case 35ULL: case 37ULL: 
        gs_ctrl_do_filter_h5ff402db6d0 = 9ULL;
        break;
      case 36ULL: 
        gs_ctrl_do_filter_h5ff402db6d0 = 10ULL;
        break;
      }
      break;
    }
  ...
  if ( (i_rst.read() == 0ULL) ) {
    ...
    default:
      ...
      case 1ULL: 
        ...
        break;
      case 2ULL: case 5ULL: case 8ULL: case 11ULL: case 14ULL: case 17ULL: case 
      20ULL: case 23ULL: 
        gs_ctrl_do_filter_h7fffffffffffe = 2ULL;
        break;
      case 3ULL: case 4ULL: case 6ULL: case 7ULL: case 9ULL: case 10ULL: case 
      12ULL: case 13ULL: case 15ULL: case 16ULL: case 18ULL: case 19ULL: case 
      21ULL: case 22ULL: case 24ULL: case 30ULL: case 32ULL: case 33ULL: case 
      34ULL: case 35ULL: case 36ULL: case 37ULL: case 38ULL: case 39ULL: case 
      40ULL: case 42ULL: 
        gs_ctrl_do_filter_h7fffffffffffe = 3ULL;
        break;
      case 25ULL: case 26ULL: case 27ULL: case 45ULL: case 46ULL: case 47ULL: 
      case 49ULL: 
      ...
      case 48ULL: 
        ...
        break;
      case 50ULL: 
        gs_ctrl_do_filter_h7fffffffffffe = 12ULL;
        break;
      }
      break;
    }
  ...
  if ( (i_rst.read() == 0ULL) ) {
    ...
    default:
      ...
      default:
        gs_ctrl_do_filter_h7fffffffffffe0 = 0ULL;
        break;
      case 1ULL: case 2ULL: case 5ULL: case 8ULL: case 11ULL: case 14ULL: case 
      17ULL: case 20ULL: case 23ULL: case 25ULL: case 26ULL: case 27ULL: case 
      45ULL: case 46ULL: case 47ULL: case 49ULL: 
        gs_ctrl_do_filter_h7fffffffffffe0 = 1ULL;
        break;
      case 3ULL: case 4ULL: case 6ULL: case 7ULL: case 9ULL: case 10ULL: case 
      12ULL: case 13ULL: case 15ULL: case 16ULL: case 18ULL: case 19ULL: case 
      21ULL: case 22ULL: case 24ULL: case 48ULL: case 50ULL: 
      ...
      case 40ULL: case 41ULL: case 42ULL: case 43ULL: case 44ULL: 
...
// resource: regr_en_sc_4
void SobelFilter::drive_gs_ctrl_do_filter_h2e0000e924924(){
  if ( (i_rst.read() == 0ULL) ) {
    gs_ctrl_do_filter_h2e0000e924924 = 0ULL;
  } else {
    switch( (sc_uint<1>)(stall0.read()) ) {
    case 1ULL: 
      break;
    default:
      ...
      default:
        ...
        break;
      case 2ULL: 
        gs_ctrl_do_filter_h2e0000e924924 = 1ULL;
        break;
      case 5ULL: 
        gs_ctrl_do_filter_h2e0000e924924 = 2ULL;
        break;
      case 8ULL: 
        gs_ctrl_do_filter_h2e0000e924924 = 3ULL;
        break;
      case 11ULL: 
        gs_ctrl_do_filter_h2e0000e924924 = 4ULL;
        break;
      case 14ULL: 
        gs_ctrl_do_filter_h2e0000e924924 = 5ULL;
        break;
      case 17ULL: 
        gs_ctrl_do_filter_h2e0000e924924 = 6ULL;
        break;
      case 20ULL: 
        gs_ctrl_do_filter_h2e0000e924924 = 7ULL;
        break;
      case 23ULL: 
        gs_ctrl_do_filter_h2e0000e924924 = 8ULL;
        break;
      case 25ULL: 
        gs_ctrl_do_filter_h2e0000e924924 = 9ULL;
        break;
      case 26ULL: 
        gs_ctrl_do_filter_h2e0000e924924 = 10ULL;
        break;
      case 27ULL: 
        gs_ctrl_do_filter_h2e0000e924924 = 11ULL;
        break;
      case 45ULL: 
        gs_ctrl_do_filter_h2e0000e924924 = 12ULL;
        break;
      case 46ULL: 
        gs_ctrl_do_filter_h2e0000e924924 = 13ULL;
        break;
      case 47ULL: 
        gs_ctrl_do_filter_h2e0000e924924 = 14ULL;
        break;
      case 49ULL: 
        gs_ctrl_do_filter_h2e0000e924924 = 15ULL;
        break;
      }
      break;
    }
